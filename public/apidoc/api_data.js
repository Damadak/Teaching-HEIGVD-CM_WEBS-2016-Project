define({ "api": [
      ...
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            ...
            "description": "<p>The issue has some parameters with unexpected token</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
      ...
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "ValidationError",
            "description": "<p>There are missing parameters or uncorrect types</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
  ...
  },
  {
    ...
    "group": "Issue",
    "description": "<p>This allow to get all the Issues in a period of two dates</p>",
    "examples": [
      {
        "title": "Example usage:",
  ...
  },
  {
    ...
    "group": "Issue",
    "description": "<p>This allow to give an example of pagination</p>",
    "success": {
      "fields": {
        "Success 200": [
          {
      ...
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "IssueNotFound",
            "description": "<p>The Issue not found</p>"
          }
        ]
      }
    },
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "UnexpectedToken",
            "description": "<p>The type has some parameters with unexpected token</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
    ...
    "examples": [
      {
        ...
        "content": "http://localhost/api/types?embed=author",
        "type": "json"
      }
    ],
    "success": {
  ...
  },
  {
    "type": "function",
    "url": "/users",
    "title": "Count the issue of an user",
    "version": "0.0.0",
    "name": "CountIssuesUser",
    "group": "User",
    "description": "<p>This allow to count the issues of an User</p>",
  ...
  },
  {
    "type": "function",
    "url": "/users",
    "title": "Create the array to count the number of Issues posted by an User",
    "version": "0.0.0",
    "name": "CreateArrayIssuesUser",
    "group": "User",
    "description": "<p>This allow create the array to count the number of Issues posted by an User</p>",
    "filename": "app/controllers/users.js",
    "groupTitle": "User"
  },
  {
  ...
  },
  {
    ...
    "version": "0.0.0",
    "name": "GetMostIssuesSolvedUsers",
    "group": "User",
    "description": "<p>This allow to filter the users by the number of issues solved</p>",
    "success": {
      "fields": {
        "Success 200": [
          {
  ...
  },
  {
    ...
    "group": "User",
    "description": "<p>This allow to filter the users by the number of the most issues posted</p>",
    "success": {
      "fields": {
        "Success 200": [
          {
